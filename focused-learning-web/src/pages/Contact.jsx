...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, title: 'Email Support', value: 'alekhyapuram08@gmail.com', sub: 'We reply to all emails', color: 'text-blue-400' },
    { icon: Phone, title: 'Phone Support', value: '+91 98765 43210', sub: 'Mon - Sat, 10AM - 6PM', color: 'text-green-400' },
    { icon: MapPin, title: 'Our Location', value: 'Surampalem, Andhra Pradesh', sub: 'Surampalem, 533437', color: 'text-red-400' },
  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        {/* Contact Form */}
        <section className="bg-card/30 backdrop-blur-xl border border-white/5 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
